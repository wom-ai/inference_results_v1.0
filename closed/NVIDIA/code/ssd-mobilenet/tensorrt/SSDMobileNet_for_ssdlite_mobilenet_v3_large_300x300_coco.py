...
class SSDMobileNet(BenchmarkBuilder):
    ...
    def __init__(self, args):
        ...
        # Model path
        self.model_path = dict_get(args, "model_path", default="build/models/frozen_model_ssdlite_mobilenet_v3_large_300x300_coco/frozen_inference_graph.pb")
        ...
        if self.precision == "int8":
            ...
            cache_file = dict_get(self.args, "cache_file", default="code/ssd-mobilenet/tensorrt/calibrator_ssdlite_mobilenet_v3_large_300x300_coco.cache")
    ...
    def initialize(self):
        ...
        uff_model = uff.from_tensorflow_frozen_model(self.model_path, preprocessor="code/ssd-mobilenet/tensorrt/SSDMobileNet_for_ssdlite_mobilenet_v3_large_300x300_coco.py")
