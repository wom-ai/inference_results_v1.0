...
class SSDMobileNet(BenchmarkBuilder):
    ...
    def __init__(self, args):
        ...
        if self.precision == "int8":
            ...
            cache_file = dict_get(self.args, "cache_file", default="code/ssd-mobilenet/tensorrt/calibrator_ssdlite_mobilenet_v2_ball.cache")
    ...
    def initialize(self):
        ...
        uff_model = uff.from_tensorflow_frozen_model(self.model_path, preprocessor="code/ssd-mobilenet/tensorrt/SSDMobileNet_for_ssdlite_mobilenet_v2_ball.py")
